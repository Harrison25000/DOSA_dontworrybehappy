...
def return_prediction(path):
    ...
    try:
        ...
        return EMOTION_DICT[emotion_label], string
    except:
        pass
...
def first_run(text, cap):
    while (True):
        ...
        try:
            ...
            if string[2:] == "00":
                string = "0.100"
            confidence = cv2.putText(img, "With probability: " + string[2:] + "%" , (95, 120), font, 1.0, COLOUR_DICT[text], 2, cv2.LINE_AA)
        except:
            pass
        ...
        cv2.putText(img, "Press Q: To Quit", (100, 200), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
        ...
        try:
            text, string = return_prediction("test.jpg")
        except:
            pass
